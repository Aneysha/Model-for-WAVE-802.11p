%RICIAN FADING Channel(Highway LOS):

function [outsignal,Response_FN] = RICIANChannelHighwayLOS(insignal)
avg_pathgain = [0 -10 -15 -20];
path_delay = [0 100 167 500]*1e-9;
doppler_shift = [0 689 -492 886];
K_factor = [1e12 0 0 0];
samp_rate = 10*1e6;
